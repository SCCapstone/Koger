...
const routes = [
    ...
    {
        path: 'admin-login',
        loadChildren: () => Promise.all(/*! import() | admin-login-admin-login-module */[__webpack_require__.e("default~admin-login-admin-login-module~tab3-tab3-module"), __webpack_require__.e("admin-login-admin-login-module")]).then(__webpack_require__.bind(null, /*! ./admin-login/admin-login.module */ "./src/app/admin-login/admin-login.module.ts")).then(m => m.Tab3PageModule)
    }
];
...
module.exports = __webpack_require__(/*! C:\Users\James\code\CSCE492\KogerApp\src\main.ts */"./src/main.ts");
